...
export const QUALITY = {
  high: { loadRadius: 8, detailRadius: 2, midRadius: 4, shadows: true, dpr: 2, traffic: 24, post: true, clouds: true },
  low: { loadRadius: 6, detailRadius: 1, midRadius: 3, shadows: false, dpr: 1.3, traffic: 14, post: false, clouds: false }
};
